// permet d'executer un bout de code dans le cadre d'un changmeent de propriété
class Observable {
    ...
    set(prop, value) {
        ...
        if(typeof old === 'object') {
            ...
            if (old.length !== value.length) {
                ...
                // affecte a la propriete temporarie qui commence par _ à la valeur  difinitive
                this[`_${prop}`] = value;
